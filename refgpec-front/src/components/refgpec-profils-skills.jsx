...
var RefGpecProfilsSkills = React.createClass({
  ...
  render: function () {
    ...
    let rgPS = [];
    let key = 'ps-1';
    if (self.props.profilsSkillsModel.profilsSkills[key]) {
      rgPS.push(
        <RefGpecProfilSkill
          key={key} psId={key}
          ...
          psData={self.props.profilsSkillsModel.profilsSkills[key]}
                          ...
                          <tr>
                            ...
                            <td>
                              <select className="form-control" id="levels-datalist">
                                ...
                                <option value="2" title="Capacité à mettre en œuvre et/ou en pratique, une compétence, un savoir, une technique">Pratique</option>
