                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="panel panel-default">
                            <div className="panel-heading">Gestion des Domaines de compétences</div>
                            <div className="panel-body">
                                <p>
                                    Depuis cet onglet il est possible d'administrer les
                                    différents domaines que l'on pourra ensuite{" "}
                                    <a
                        ...
                        <div
                            className="progress"
                            style={{
                                display: self.props.skillsDomainsModel.ajaxLoading ? "block" : "none"
                            }}
                        >
                            <div
